...
import bot.inker.core.tasker.InkCronSchedulerJob
import bot.inker.core.tasker.InkTasker
...
class InkerBotModule : JvmPlugin {
  override fun configure(binder: Binder) {
    ...
    binder.bind(SchedulerService::class.java).to(InkSchedulerService::class.java)
    binder.bind(CommandService::class.java).to(InkCommandService::class.java)
    // tasker
    binder.bind(Tasker::class.java).to(InkTasker::class.java)
    binder.bind(CronSchedulerJob.Factory::class.java).to(InkCronSchedulerJob.Factory::class.java)
    // common
